...
{
    public class ParametroClassesViewModel : ObservableObject, IPageViewModel
    {
        #region Campos

        private Classe _classeSelecionada = new();
        private Classe _classeAlterar = new();
        ...
        public ParametroClassesViewModel(IDialogCoordinator dialogCoordinator)
        {
        ...
        {
            get { return _classeSelecionada; }
            set
            {
                _classeSelecionada = value;
                OnPropertyChanged(nameof(ClasseSelecionada));
                ...
                {
                    ClasseAlterar = (Classe)ClasseSelecionada.Clone();
                    PermiteEditar = ClasseAlterar != null;
                    PermiteDeletar = ClasseAlterar != null;
                    // Define valores
                    try
                    {
                        ClasseAlterar.Status = ListaStatus.First(stat => stat.Id == ClasseSelecionada.Status.Id);
                    }
                    catch (Exception)
                    {
                    }
        ...
        public Classe ClasseAlterar
        {
            get { return _classeAlterar; }
            set
            {
                _classeAlterar = value;
                OnPropertyChanged(nameof(ClasseAlterar));
            }
        }
        ...
        {
            ClasseAlterar = new Classe();
            ClasseAlterar.Status = null;
        ...
        private void Cancelar()
        {
            ...
            CancelarVisivel = false;
            PermiteAdicionar = true;
            PermiteEditar = ClasseAlterar != null && ClasseAlterar?.Id != null; ;
            PermiteCancelar = false;
            PermiteSalvar = false;
            PermiteDeletar = ClasseAlterar != null && ClasseAlterar?.Id != null; ;
        }
        ...
        private async Task SalvarAsync()
        {
            ...
            MensagemStatus = "Salvando dados da classe '" + ClasseAlterar.Nome + "', aguarde...";
            CancelarVisivel = true;
            PermiteCancelar = true;
            PermiteSalvar = false;
            PermiteAdicionar = false;
            ...
            try
            {
                await ClasseAlterar.SalvarClasseDatabaseAsync(_cts.Token);
            }
            catch (Exception ex)
            {
                ValorProgresso = 0;
            ...
            int? idClasseAlterado = ClasseAlterar.Id;
            ...
            try
            {
                ClasseSelecionada = ListaClasses.First(clas => clas.Id == idClasseAlterado);
            }
            catch (Exception)
            {
            }
        ...
        private async Task Deletar()
        {
            ...
            var respostaMensagem = await _dialogCoordinator.ShowMessageAsync(this,
                "Atenção", "Tem certeza que deseja excluir a classe '" + ClasseAlterar.Nome + "'? " +
            ...
            ProgressoVisivel = true;
            ProgressoEhIndeterminavel = true;
            MensagemStatus = "Deletando classe '" + ClasseAlterar.Nome + "', aguarde...";
            CancelarVisivel = true;
            PermiteCancelar = true;
            PermiteSalvar = false;
            PermiteAdicionar = false;
            ...
            try
            {
                await ClasseAlterar.DeletarClasseDatabaseAsync(_cts.Token);
            }
            catch (Exception ex)
            {
                ValorProgresso = 0;
            ...
            PermiteEditar = false;
            PermiteDeletar = false;
            MensagemStatus = "Classe excluída com sucesso!";
