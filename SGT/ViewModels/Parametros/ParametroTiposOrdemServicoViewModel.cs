...
{
    public class ParametroTiposOrdemServicoViewModel : ObservableObject, IPageViewModel
    {
        #region Campos

        private TipoOrdemServico _tipoOrdemServicoSelecionado = new();
        private TipoOrdemServico _tipoOrdemServicoAlterar = new();
        ...
        public ParametroTiposOrdemServicoViewModel(IDialogCoordinator dialogCoordinator)
        {
        ...
        public string Name
        {
            get
            {
                return "Tipos de ordem de serviço";
            }
        }
        ...
        public void LimparViewModel()
        {
            try
            {
                _tipoOrdemServicoSelecionado = null;
                _cts = null;
        ...
        public TipoOrdemServico TipoOrdemServicoSelecionado
        {
            get { return _tipoOrdemServicoSelecionado; }
            set
            {
                _tipoOrdemServicoSelecionado = value;
                OnPropertyChanged(nameof(TipoOrdemServicoSelecionado));
                if (TipoOrdemServicoSelecionado == null)
                {
                    TipoOrdemServicoAlterar = null;
                }
                else
                {
                    TipoOrdemServicoAlterar = (TipoOrdemServico)TipoOrdemServicoSelecionado.Clone();
                    PermiteEditar = TipoOrdemServicoAlterar != null;
                    PermiteDeletar = TipoOrdemServicoAlterar != null;
                    // Define valores
                    try
                    {
                        TipoOrdemServicoAlterar.Status = ListaStatus.First(stat => stat.Id == TipoOrdemServicoSelecionado.Status.Id);
                    }
                    catch (Exception)
                    {
                    }
        ...
        public TipoOrdemServico TipoOrdemServicoAlterar
        {
            get { return _tipoOrdemServicoAlterar; }
            set
            {
                _tipoOrdemServicoAlterar = value;
                OnPropertyChanged(nameof(TipoOrdemServicoAlterar));
            }
        }
        ...
        {
            TipoOrdemServicoAlterar = new TipoOrdemServico();
            TipoOrdemServicoAlterar.Status = null;
        ...
        private void Cancelar()
        {
            ...
            CancelarVisivel = false;
            PermiteAdicionar = true;
            PermiteEditar = TipoOrdemServicoAlterar != null && TipoOrdemServicoAlterar?.Id != null; ;
            PermiteCancelar = false;
            PermiteSalvar = false;
            PermiteDeletar = TipoOrdemServicoAlterar != null && TipoOrdemServicoAlterar?.Id != null; ;
        }
        ...
        private async Task SalvarAsync()
        {
            ...
            MensagemStatus = "Salvando dados do tipo de ordem de serviço '" + TipoOrdemServicoAlterar.Nome + "', aguarde...";
            CancelarVisivel = true;
            PermiteCancelar = true;
            PermiteSalvar = false;
            PermiteAdicionar = false;
            ...
            try
            {
                await TipoOrdemServicoAlterar.SalvarTipoOrdemServicoDatabaseAsync(_cts.Token);
            }
            catch (Exception ex)
            {
                ValorProgresso = 0;
            ...
            int? idTipoOrdemServicoAlterado = TipoOrdemServicoAlterar.Id;
            ...
            try
            {
                TipoOrdemServicoSelecionado = ListaTiposOrdemServico.First(clie => clie.Id == idTipoOrdemServicoAlterado);
            }
            catch (Exception)
            {
            }
        ...
        private async Task Deletar()
        {
            ...
            var respostaMensagem = await _dialogCoordinator.ShowMessageAsync(this,
                "Atenção", "Tem certeza que deseja excluir o tipo de ordem de serviço '" + TipoOrdemServicoAlterar.Nome + "'? " +
            ...
            ProgressoVisivel = true;
            ProgressoEhIndeterminavel = true;
            MensagemStatus = "Deletando tipo de ordem de serviço '" + TipoOrdemServicoAlterar.Nome + "', aguarde...";
            CancelarVisivel = true;
            PermiteCancelar = true;
            PermiteSalvar = false;
            PermiteAdicionar = false;
            ...
            try
            {
                await TipoOrdemServicoAlterar.DeletarTipoOrdemServicoDatabaseAsync(_cts.Token);
            }
            catch (Exception ex)
            {
                ValorProgresso = 0;
            ...
            TipoOrdemServicoSelecionado = null;
            ValorProgresso = 0;
            ListaHabilitada = true;
            ControlesHabilitados = false;
            ProgressoVisivel = false;
            ...
            PermiteEditar = false;
            PermiteDeletar = false;
            MensagemStatus = "Tipo de ordem de serviço excluído com sucesso!";
