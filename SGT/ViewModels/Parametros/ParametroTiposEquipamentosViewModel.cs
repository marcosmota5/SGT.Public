...
{
    public class ParametroTiposEquipamentosViewModel : ObservableObject, IPageViewModel
    {
        #region Campos

        private TipoEquipamento _tipoEquipamentoSelecionado = new();
        private TipoEquipamento _tipoEquipamentoAlterar = new();
        ...
        public ParametroTiposEquipamentosViewModel(IDialogCoordinator dialogCoordinator)
        {
        ...
        public TipoEquipamento TipoEquipamentoSelecionado
        {
            get { return _tipoEquipamentoSelecionado; }
            set
            {
                _tipoEquipamentoSelecionado = value;
                OnPropertyChanged(nameof(TipoEquipamentoSelecionado));
                if (TipoEquipamentoSelecionado == null)
                {
                    TipoEquipamentoAlterar = null;
                }
                else
                {
                    TipoEquipamentoAlterar = (TipoEquipamento)TipoEquipamentoSelecionado.Clone();
                    PermiteEditar = TipoEquipamentoAlterar != null;
                    PermiteDeletar = TipoEquipamentoAlterar != null;
                    // Define valores
                    try
                    {
                        TipoEquipamentoAlterar.Status = ListaStatus.First(stat => stat.Id == TipoEquipamentoSelecionado.Status.Id);
                    }
                    catch (Exception)
                    {
                    }
        ...
        public TipoEquipamento TipoEquipamentoAlterar
        {
            get { return _tipoEquipamentoAlterar; }
            set
            {
                _tipoEquipamentoAlterar = value;
                OnPropertyChanged(nameof(TipoEquipamentoAlterar));
            }
        }
        ...
        {
            TipoEquipamentoAlterar = new TipoEquipamento();
            TipoEquipamentoAlterar.Status = null;
        ...
        private void Cancelar()
        {
            ...
            CancelarVisivel = false;
            PermiteAdicionar = true;
            PermiteEditar = TipoEquipamentoAlterar != null && TipoEquipamentoAlterar?.Id != null; ;
            PermiteCancelar = false;
            PermiteSalvar = false;
            PermiteDeletar = TipoEquipamentoAlterar != null && TipoEquipamentoAlterar?.Id != null; ;
        }
        ...
        private async Task SalvarAsync()
        {
            ...
            MensagemStatus = "Salvando dados do tipo de equipamento '" + TipoEquipamentoAlterar.Nome + "', aguarde...";
            CancelarVisivel = true;
            PermiteCancelar = true;
            PermiteSalvar = false;
            PermiteAdicionar = false;
            ...
            try
            {
                await TipoEquipamentoAlterar.SalvarTipoEquipamentoDatabaseAsync(_cts.Token);
            }
            catch (Exception ex)
            {
                ValorProgresso = 0;
            ...
            int? idTipoEquipamentoAlterado = TipoEquipamentoAlterar.Id;
            ...
            try
            {
                TipoEquipamentoSelecionado = ListaTiposEquipamentos.First(clie => clie.Id == idTipoEquipamentoAlterado);
            }
            catch (Exception)
            {
            }
        ...
        private async Task Deletar()
        {
            ...
            var respostaMensagem = await _dialogCoordinator.ShowMessageAsync(this,
                "Atenção", "Tem certeza que deseja excluir o tipo de equipamento '" + TipoEquipamentoAlterar.Nome + "'? " +
            ...
            ProgressoVisivel = true;
            ProgressoEhIndeterminavel = true;
            MensagemStatus = "Deletando tipo de equipamento '" + TipoEquipamentoAlterar.Nome + "', aguarde...";
            CancelarVisivel = true;
            PermiteCancelar = true;
            PermiteSalvar = false;
            PermiteAdicionar = false;
            ...
            try
            {
                await TipoEquipamentoAlterar.DeletarTipoEquipamentoDatabaseAsync(_cts.Token);
            }
            catch (Exception ex)
            {
                ValorProgresso = 0;
            ...
            TipoEquipamentoSelecionado = null;
            ValorProgresso = 0;
            ListaHabilitada = true;
            ControlesHabilitados = false;
            ProgressoVisivel = false;
            ...
            PermiteEditar = false;
            PermiteDeletar = false;
            MensagemStatus = "Tipo de equipamento excluído com sucesso!";
