...
{
    public class ParametroTiposManutencaoViewModel : ObservableObject, IPageViewModel
    {
        #region Campos

        private TipoManutencao _tipoManutencaoSelecionado = new();
        private TipoManutencao _tipoManutencaoAlterar = new();
        ...
        private ObservableCollection<TipoManutencao> _listaTiposManutencao = new();
        ...
        private ICommand _comandoUnloaded;

        #endregion Campos

        #region Construtores

        public ParametroTiposManutencaoViewModel(IDialogCoordinator dialogCoordinator)
        {
        ...
        public void LimparViewModel()
        {
            try
            {
                _tipoManutencaoSelecionado = null;
                _cts = null;
                _listaTiposManutencao = null;
                _listaStatus = null;
                _comandoSalvar = null;
        ...
        public TipoManutencao TipoManutencaoSelecionado
        {
            get { return _tipoManutencaoSelecionado; }
            set
            {
                _tipoManutencaoSelecionado = value;
                OnPropertyChanged(nameof(TipoManutencaoSelecionado));
                if (TipoManutencaoSelecionado == null)
                {
                    TipoManutencaoAlterar = null;
                }
                else
                {
                    TipoManutencaoAlterar = (TipoManutencao)TipoManutencaoSelecionado.Clone();
                    PermiteEditar = TipoManutencaoAlterar != null;
                    PermiteDeletar = TipoManutencaoAlterar != null;
                    // Define valores
                    try
                    {
                        TipoManutencaoAlterar.Status = ListaStatus.First(stat => stat.Id == TipoManutencaoSelecionado.Status.Id);
                    }
                    catch (Exception)
                    {
                    }
        ...
        public TipoManutencao TipoManutencaoAlterar
        {
            get { return _tipoManutencaoAlterar; }
            set
            {
                _tipoManutencaoAlterar = value;
                OnPropertyChanged(nameof(TipoManutencaoAlterar));
            }
        }
        ...
        public ObservableCollection<TipoManutencao> ListaTiposManutencao
        {
            get { return _listaTiposManutencao; }
            set
            {
                if (value != _listaTiposManutencao)
                {
                    _listaTiposManutencao = value;
                    OnPropertyChanged(nameof(ListaTiposManutencao));
                }
            }
        }
        ...
        public ICommand ComandoUnloaded
        {
            get
            {
                if (_comandoUnloaded == null)
                {
                    _comandoUnloaded = new RelayCommand(
                        param => Unloaded(),
                        param => true
                    );
                }
                return _comandoUnloaded;
            }
        }
        ...
        public async Task ConstrutorAsync()
        {
            try
            {
                ...
                await TipoManutencao.PreencheListaTiposManutencaoAsync(ListaTiposManutencao, true, null, CancellationToken.None, "WHERE tima.id_tipo_manutencao NOT IN (1,5,12) ORDER BY tima.nome ASC", "");
        ...
        {
            TipoManutencaoAlterar = new TipoManutencao();
            TipoManutencaoAlterar.Status = null;
        ...
        private void Cancelar()
        {
            ...
            CancelarVisivel = false;
            PermiteAdicionar = true;
            PermiteEditar = TipoManutencaoAlterar != null && TipoManutencaoAlterar?.Id != null; ;
            PermiteCancelar = false;
            PermiteSalvar = false;
            PermiteDeletar = TipoManutencaoAlterar != null && TipoManutencaoAlterar?.Id != null; ;
        }

        private void Unloaded()
        {
            System.Diagnostics.Trace.WriteLine("ASDA");
        }
        ...
        private async Task SalvarAsync()
        {
            ...
            MensagemStatus = "Salvando dados do tipo de manutencao '" + TipoManutencaoAlterar.Nome + "', aguarde...";
            CancelarVisivel = true;
            PermiteCancelar = true;
            PermiteSalvar = false;
            PermiteAdicionar = false;
            ...
            try
            {
                await TipoManutencaoAlterar.SalvarTipoManutencaoDatabaseAsync(_cts.Token);
            }
            catch (Exception ex)
            {
                ValorProgresso = 0;
            ...
            int? idTipoManutencaoAlterado = TipoManutencaoAlterar.Id;
            ...
            try
            {
                TipoManutencaoSelecionado = ListaTiposManutencao.First(clie => clie.Id == idTipoManutencaoAlterado);
            }
            catch (Exception)
            {
            }
        ...
        private async Task Deletar()
        {
            ...
            var respostaMensagem = await _dialogCoordinator.ShowMessageAsync(this,
                "Atenção", "Tem certeza que deseja excluir o tipo de manutenção '" + TipoManutencaoAlterar.Nome + "'? " +
            ...
            ProgressoVisivel = true;
            ProgressoEhIndeterminavel = true;
            MensagemStatus = "Deletando tipo de manutenção '" + TipoManutencaoAlterar.Nome + "', aguarde...";
            CancelarVisivel = true;
            PermiteCancelar = true;
            PermiteSalvar = false;
            PermiteAdicionar = false;
            ...
            try
            {
                await TipoManutencaoAlterar.DeletarTipoManutencaoDatabaseAsync(_cts.Token);
            }
            catch (Exception ex)
            {
                ValorProgresso = 0;
            ...
            PermiteEditar = false;
            PermiteDeletar = false;
            MensagemStatus = "Tipo de manutenção excluído com sucesso!";
