...
{
    public class ParametroFabricantesViewModel : ObservableObject, IPageViewModel
    {
        #region Campos

        private Fabricante _fabricanteSelecionado = new();
        private Fabricante _fabricanteAlterar = new();
        ...
        public ParametroFabricantesViewModel(IDialogCoordinator dialogCoordinator)
        {
        ...
        {
            get { return _fabricanteSelecionado; }
            set
            {
                _fabricanteSelecionado = value;
                OnPropertyChanged(nameof(FabricanteSelecionado));
                ...
                {
                    FabricanteAlterar = (Fabricante)FabricanteSelecionado.Clone();
                    PermiteEditar = FabricanteAlterar != null;
                    PermiteDeletar = FabricanteAlterar != null;
                    // Define valores
                    try
                    {
                        FabricanteAlterar.Status = ListaStatus.First(stat => stat.Id == FabricanteSelecionado.Status.Id);
                    }
                    catch (Exception)
                    {
                    }
        ...
        public Fabricante FabricanteAlterar
        {
            get { return _fabricanteAlterar; }
            set
            {
                _fabricanteAlterar = value;
                OnPropertyChanged(nameof(FabricanteAlterar));
            }
        }
        ...
        {
            FabricanteAlterar = new Fabricante();
            FabricanteAlterar.Status = null;
        ...
        private void Cancelar()
        {
            ...
            CancelarVisivel = false;
            PermiteAdicionar = true;
            PermiteEditar = FabricanteAlterar != null && FabricanteAlterar?.Id != null; ;
            PermiteCancelar = false;
            PermiteSalvar = false;
            PermiteDeletar = FabricanteAlterar != null && FabricanteAlterar?.Id != null; ;
        }
        ...
        private async Task SalvarAsync()
        {
            ...
            MensagemStatus = "Salvando dados do fabricante '" + FabricanteAlterar.Nome + "', aguarde...";
            CancelarVisivel = true;
            PermiteCancelar = true;
            PermiteSalvar = false;
            PermiteAdicionar = false;
            ...
            try
            {
                await FabricanteAlterar.SalvarFabricanteDatabaseAsync(_cts.Token);
            }
            catch (Exception ex)
            {
                ValorProgresso = 0;
            ...
            int? idFabricanteAlterado = FabricanteAlterar.Id;
            ...
            try
            {
                FabricanteSelecionado = ListaFabricantes.First(clie => clie.Id == idFabricanteAlterado);
            }
            catch (Exception)
            {
            }
        ...
        private async Task Deletar()
        {
            ...
            var respostaMensagem = await _dialogCoordinator.ShowMessageAsync(this,
                "Atenção", "Tem certeza que deseja excluir o fabricante '" + FabricanteAlterar.Nome + "'? " +
            ...
            ProgressoVisivel = true;
            ProgressoEhIndeterminavel = true;
            MensagemStatus = "Deletando fabricante '" + FabricanteAlterar.Nome + "', aguarde...";
            CancelarVisivel = true;
            PermiteCancelar = true;
            PermiteSalvar = false;
            PermiteAdicionar = false;
            ...
            try
            {
                await FabricanteAlterar.DeletarFabricanteDatabaseAsync(_cts.Token);
            }
            catch (Exception ex)
            {
                ValorProgresso = 0;
            ...
            PermiteEditar = false;
            PermiteDeletar = false;
            MensagemStatus = "Fabricante excluído com sucesso!";
