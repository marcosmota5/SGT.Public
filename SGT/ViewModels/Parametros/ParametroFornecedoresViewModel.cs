...
{
    public class ParametroFornecedoresViewModel : ObservableObject, IPageViewModel
    {
        #region Campos

        private Fornecedor _fornecedorSelecionado = new();
        private Fornecedor _fornecedorAlterar = new();
        ...
        public ParametroFornecedoresViewModel(IDialogCoordinator dialogCoordinator)
        {
        ...
        public Fornecedor FornecedorSelecionado
        {
            ...
            set
            {
                ...
                {
                    FornecedorAlterar = null;
                }
                else
                {
                    FornecedorAlterar = (Fornecedor)FornecedorSelecionado.Clone();
                    PermiteEditar = FornecedorAlterar != null;
                    PermiteDeletar = FornecedorAlterar != null;
                    // Define valores
                    try
                    {
                        FornecedorAlterar.Status = ListaStatus.First(stat => stat.Id == FornecedorSelecionado.Status.Id);
                    }
                    catch (Exception)
                    {
                    }
        ...
        public Fornecedor FornecedorAlterar
        {
            get { return _fornecedorAlterar; }
            set
            {
                _fornecedorAlterar = value;
                OnPropertyChanged(nameof(FornecedorAlterar));
            }
        }
        ...
        {
            FornecedorAlterar = new Fornecedor();
            FornecedorAlterar.Status = null;
        ...
        private void Cancelar()
        {
            ...
            CancelarVisivel = false;
            PermiteAdicionar = true;
            PermiteEditar = FornecedorAlterar != null && FornecedorAlterar?.Id != null; ;
            PermiteCancelar = false;
            PermiteSalvar = false;
            PermiteDeletar = FornecedorAlterar != null && FornecedorAlterar?.Id != null; ;
        }
        ...
        private async Task SalvarAsync()
        {
            ...
            MensagemStatus = "Salvando dados do fornecedor '" + FornecedorAlterar.Nome + "', aguarde...";
            CancelarVisivel = true;
            PermiteCancelar = true;
            PermiteSalvar = false;
            PermiteAdicionar = false;
            ...
            try
            {
                await FornecedorAlterar.SalvarFornecedorDatabaseAsync(_cts.Token);
            }
            catch (Exception ex)
            {
                ValorProgresso = 0;
            ...
            int? idFornecedorAlterado = FornecedorAlterar.Id;
            ...
            try
            {
                FornecedorSelecionado = ListaFornecedores.First(forn => forn.Id == idFornecedorAlterado);
            }
            catch (Exception)
            {
            }
        ...
        private async Task Deletar()
        {
            ...
            var respostaMensagem = await _dialogCoordinator.ShowMessageAsync(this,
                "Atenção", "Tem certeza que deseja excluir o fornecedor '" + FornecedorAlterar.Nome + "'? " +
            ...
            ProgressoVisivel = true;
            ProgressoEhIndeterminavel = true;
            MensagemStatus = "Deletando fornecedor '" + FornecedorAlterar.Nome + "', aguarde...";
            CancelarVisivel = true;
            PermiteCancelar = true;
            PermiteSalvar = false;
            PermiteAdicionar = false;
            ...
            try
            {
                await FornecedorAlterar.DeletarFornecedorDatabaseAsync(_cts.Token);
            }
            catch (Exception ex)
            {
                ValorProgresso = 0;
