...
{
    public class ParametroStatusEquipamentoAposManutencaoViewModel : ObservableObject, IPageViewModel
    {
        #region Campos

        private StatusEquipamentoAposManutencao _statusEquipamentoAposManutencaoSelecionado = new();
        private StatusEquipamentoAposManutencao _statusEquipamentoAposManutencaoAlterar = new();
        ...
        public ParametroStatusEquipamentoAposManutencaoViewModel(IDialogCoordinator dialogCoordinator)
        {
        ...
        public string Name
        {
            get
            {
                return "Status do equipamento após a manutenção";
            }
        }
        ...
        public void LimparViewModel()
        {
            try
            {
                _statusEquipamentoAposManutencaoSelecionado = null;
                _cts = null;
        ...
        public StatusEquipamentoAposManutencao StatusEquipamentoAposManutencaoSelecionado
        {
            get { return _statusEquipamentoAposManutencaoSelecionado; }
            set
            {
                _statusEquipamentoAposManutencaoSelecionado = value;
                OnPropertyChanged(nameof(StatusEquipamentoAposManutencaoSelecionado));
                if (StatusEquipamentoAposManutencaoSelecionado == null)
                {
                    StatusEquipamentoAposManutencaoAlterar = null;
                }
                else
                {
                    StatusEquipamentoAposManutencaoAlterar = (StatusEquipamentoAposManutencao)StatusEquipamentoAposManutencaoSelecionado.Clone();
                    PermiteEditar = StatusEquipamentoAposManutencaoAlterar != null;
                    PermiteDeletar = StatusEquipamentoAposManutencaoAlterar != null;
                    // Define valores
                    try
                    {
                        StatusEquipamentoAposManutencaoAlterar.Status = ListaStatus.First(stat => stat.Id == StatusEquipamentoAposManutencaoSelecionado.Status.Id);
                    }
                    catch (Exception)
                    {
                    }
        ...
        public StatusEquipamentoAposManutencao StatusEquipamentoAposManutencaoAlterar
        {
            get { return _statusEquipamentoAposManutencaoAlterar; }
            set
            {
                _statusEquipamentoAposManutencaoAlterar = value;
                OnPropertyChanged(nameof(StatusEquipamentoAposManutencaoAlterar));
            }
        }
        ...
        {
            StatusEquipamentoAposManutencaoAlterar = new StatusEquipamentoAposManutencao();
            StatusEquipamentoAposManutencaoAlterar.Status = null;
        ...
        private void Cancelar()
        {
            ...
            CancelarVisivel = false;
            PermiteAdicionar = true;
            PermiteEditar = StatusEquipamentoAposManutencaoAlterar != null && StatusEquipamentoAposManutencaoAlterar?.Id != null; ;
            PermiteCancelar = false;
            PermiteSalvar = false;
            PermiteDeletar = StatusEquipamentoAposManutencaoAlterar != null && StatusEquipamentoAposManutencaoAlterar?.Id != null; ;
        }
        ...
        private async Task SalvarAsync()
        {
            ...
            MensagemStatus = "Salvando dados do status do equipamento após a manutenção '" + StatusEquipamentoAposManutencaoAlterar.Nome + "', aguarde...";
            CancelarVisivel = true;
            PermiteCancelar = true;
            PermiteSalvar = false;
            PermiteAdicionar = false;
            ...
            try
            {
                await StatusEquipamentoAposManutencaoAlterar.SalvarStatusEquipamentoAposManutencaoDatabaseAsync(_cts.Token);
            }
            catch (Exception ex)
            {
                ValorProgresso = 0;
            ...
            int? idStatusEquipamentoAposManutencaoAlterado = StatusEquipamentoAposManutencaoAlterar.Id;
            ...
            try
            {
                StatusEquipamentoAposManutencaoSelecionado = ListaStatusEquipamentoAposManutencao.First(seam => seam.Id == idStatusEquipamentoAposManutencaoAlterado);
            }
            catch (Exception)
            {
            }
        ...
        private async Task Deletar()
        {
            ...
            var respostaMensagem = await _dialogCoordinator.ShowMessageAsync(this,
                "Atenção", "Tem certeza que deseja excluir o status do equipamento após a manutenção '" + StatusEquipamentoAposManutencaoAlterar.Nome + "'? " +
            ...
            ProgressoVisivel = true;
            ProgressoEhIndeterminavel = true;
            MensagemStatus = "Deletando status do equipamento após a manutenção '" + StatusEquipamentoAposManutencaoAlterar.Nome + "', aguarde...";
            CancelarVisivel = true;
            PermiteCancelar = true;
            PermiteSalvar = false;
            PermiteAdicionar = false;
            ...
            try
            {
                await StatusEquipamentoAposManutencaoAlterar.DeletarStatusEquipamentoAposManutencaoDatabaseAsync(_cts.Token);
            }
            catch (Exception ex)
            {
                ValorProgresso = 0;
            ...
            StatusEquipamentoAposManutencaoSelecionado = null;
            ValorProgresso = 0;
            ListaHabilitada = true;
            ControlesHabilitados = false;
            ProgressoVisivel = false;
            ...
            PermiteEditar = false;
            PermiteDeletar = false;
            MensagemStatus = "status do equipamento após a manutenção excluído com sucesso!";
