...
{
    public class ParametroConjuntosViewModel : ObservableObject, IPageViewModel
    {
        #region Campos

        private Conjunto _conjuntoSelecionado = new();
        private Conjunto _conjuntoAlterar = new();
        ...
        public ParametroConjuntosViewModel(IDialogCoordinator dialogCoordinator)
        {
        ...
        public Conjunto ConjuntoSelecionado
        {
            get { return _conjuntoSelecionado; }
            set
            {
                _conjuntoSelecionado = value;
                OnPropertyChanged(nameof(ConjuntoSelecionado));
                if (ConjuntoSelecionado == null)
                {
                    ConjuntoAlterar = null;
                }
                else
                {
                    ConjuntoAlterar = (Conjunto)ConjuntoSelecionado.Clone();
                    PermiteEditar = ConjuntoAlterar != null;
                    PermiteDeletar = ConjuntoAlterar != null;
                    // Define valores
                    try
                    {
                        ConjuntoAlterar.Status = ListaStatus.First(stat => stat.Id == ConjuntoSelecionado.Status.Id);
                    }
                    catch (Exception)
                    {
                    }
        ...
        public Conjunto ConjuntoAlterar
        {
            get { return _conjuntoAlterar; }
            set
            {
                _conjuntoAlterar = value;
                OnPropertyChanged(nameof(ConjuntoAlterar));
            }
        }
        ...
        {
            ConjuntoAlterar = new Conjunto();
            ConjuntoAlterar.Status = null;
        ...
        private void Cancelar()
        {
            ...
            CancelarVisivel = false;
            PermiteAdicionar = true;
            PermiteEditar = ConjuntoAlterar != null && ConjuntoAlterar?.Id != null; ;
            PermiteCancelar = false;
            PermiteSalvar = false;
            PermiteDeletar = ConjuntoAlterar != null && ConjuntoAlterar?.Id != null; ;
        }
        ...
        private async Task SalvarAsync()
        {
            ...
            MensagemStatus = "Salvando dados do conjunto '" + ConjuntoAlterar.Nome + "', aguarde...";
            CancelarVisivel = true;
            PermiteCancelar = true;
            PermiteSalvar = false;
            PermiteAdicionar = false;
            ...
            try
            {
                await ConjuntoAlterar.SalvarConjuntoDatabaseAsync(_cts.Token);
            }
            catch (Exception ex)
            {
                ValorProgresso = 0;
            ...
            int? idConjuntoAlterado = ConjuntoAlterar.Id;
            ...
            try
            {
                ConjuntoSelecionado = ListaConjuntos.First(conj => conj.Id == idConjuntoAlterado);
            }
            catch (Exception)
            {
            }
        ...
        private async Task Deletar()
        {
            ...
            var respostaMensagem = await _dialogCoordinator.ShowMessageAsync(this,
                "Atenção", "Tem certeza que deseja excluir o conjunto '" + ConjuntoAlterar.Nome + "'? " +
            ...
            ProgressoVisivel = true;
            ProgressoEhIndeterminavel = true;
            MensagemStatus = "Deletando conjunto '" + ConjuntoAlterar.Nome + "', aguarde...";
            CancelarVisivel = true;
            PermiteCancelar = true;
            PermiteSalvar = false;
            PermiteAdicionar = false;
            ...
            try
            {
                await ConjuntoAlterar.DeletarConjuntoDatabaseAsync(_cts.Token);
            }
            catch (Exception ex)
            {
                ValorProgresso = 0;
            ...
            PermiteEditar = false;
            PermiteDeletar = false;
            MensagemStatus = "Conjunto excluído com sucesso!";
