...
{
    public class ParametroUsosIndevidosViewModel : ObservableObject, IPageViewModel
    {
        #region Campos

        private UsoIndevido _usoIndevidoSelecionado = new();
        private UsoIndevido _usoIndevidoAlterar = new();
        ...
        private ObservableCollection<UsoIndevido> _listaUsosIndevidos = new();
        ...
        public ParametroUsosIndevidosViewModel(IDialogCoordinator dialogCoordinator)
        {
        ...
        public void LimparViewModel()
        {
            try
            {
                _usoIndevidoSelecionado = null;
                _cts = null;
                _listaUsosIndevidos = null;
                _listaStatus = null;
                _comandoSalvar = null;
        ...
        public UsoIndevido UsoIndevidoSelecionado
        {
            get { return _usoIndevidoSelecionado; }
            set
            {
                _usoIndevidoSelecionado = value;
                OnPropertyChanged(nameof(UsoIndevidoSelecionado));
                if (UsoIndevidoSelecionado == null)
                {
                    UsoIndevidoAlterar = null;
                }
                else
                {
                    UsoIndevidoAlterar = (UsoIndevido)UsoIndevidoSelecionado.Clone();
                    PermiteEditar = UsoIndevidoAlterar != null;
                    PermiteDeletar = UsoIndevidoAlterar != null;
                    // Define valores
                    try
                    {
                        UsoIndevidoAlterar.Status = ListaStatus.First(stat => stat.Id == UsoIndevidoSelecionado.Status.Id);
                    }
                    catch (Exception)
                    {
                    }
        ...
        public UsoIndevido UsoIndevidoAlterar
        {
            get { return _usoIndevidoAlterar; }
            set
            {
                _usoIndevidoAlterar = value;
                OnPropertyChanged(nameof(UsoIndevidoAlterar));
            }
        }
        ...
        public ObservableCollection<UsoIndevido> ListaUsosIndevidos
        {
            get { return _listaUsosIndevidos; }
            set
            {
                if (value != _listaUsosIndevidos)
                {
                    _listaUsosIndevidos = value;
                    OnPropertyChanged(nameof(ListaUsosIndevidos));
                }
            }
        }
        ...
        public async Task ConstrutorAsync()
        {
            try
            {
                ...
                await UsoIndevido.PreencheListaUsosIndevidosAsync(ListaUsosIndevidos, true, null, CancellationToken.None, "ORDER BY usoi.nome ASC", "");
        ...
        {
            UsoIndevidoAlterar = new UsoIndevido();
            UsoIndevidoAlterar.Status = null;
        ...
        private void Cancelar()
        {
            ...
            CancelarVisivel = false;
            PermiteAdicionar = true;
            PermiteEditar = UsoIndevidoAlterar != null && UsoIndevidoAlterar?.Id != null; ;
            PermiteCancelar = false;
            PermiteSalvar = false;
            PermiteDeletar = UsoIndevidoAlterar != null && UsoIndevidoAlterar?.Id != null; ;
        }
        ...
        private async Task SalvarAsync()
        {
            ...
            MensagemStatus = "Salvando dados do uso indevido '" + UsoIndevidoAlterar.Nome + "', aguarde...";
            CancelarVisivel = true;
            PermiteCancelar = true;
            PermiteSalvar = false;
            PermiteAdicionar = false;
            ...
            try
            {
                await UsoIndevidoAlterar.SalvarUsoIndevidoDatabaseAsync(_cts.Token);
            }
            catch (Exception ex)
            {
                ValorProgresso = 0;
            ...
            int? idUsoIndevidoAlterado = UsoIndevidoAlterar.Id;
            ...
            try
            {
                UsoIndevidoSelecionado = ListaUsosIndevidos.First(usoi => usoi.Id == idUsoIndevidoAlterado);
            }
            catch (Exception)
            {
            }
        ...
        private async Task Deletar()
        {
            ...
            var respostaMensagem = await _dialogCoordinator.ShowMessageAsync(this,
                "Atenção", "Tem certeza que deseja excluir o uso indevido '" + UsoIndevidoAlterar.Nome + "'? " +
            ...
            ProgressoVisivel = true;
            ProgressoEhIndeterminavel = true;
            MensagemStatus = "Deletando uso indevido '" + UsoIndevidoAlterar.Nome + "', aguarde...";
            CancelarVisivel = true;
            PermiteCancelar = true;
            PermiteSalvar = false;
            PermiteAdicionar = false;
            ...
            try
            {
                await UsoIndevidoAlterar.DeletarUsoIndevidoDatabaseAsync(_cts.Token);
            }
            catch (Exception ex)
            {
                ValorProgresso = 0;
            ...
            PermiteEditar = false;
            PermiteDeletar = false;
            MensagemStatus = "Uso indevido excluído com sucesso!";
