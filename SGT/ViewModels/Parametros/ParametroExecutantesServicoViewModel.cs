...
{
    public class ParametroExecutantesServicoViewModel : ObservableObject, IPageViewModel
    {
        #region Campos

        private ExecutanteServico _executanteServicoSelecionado = new();
        private ExecutanteServico _executanteServicoAlterar = new();
        ...
        private ObservableCollection<ExecutanteServico> _listaExecutantesServico = new();
        ...
        public ParametroExecutantesServicoViewModel(IDialogCoordinator dialogCoordinator)
        {
        ...
        public void LimparViewModel()
        {
            try
            {
                _executanteServicoSelecionado = null;
                _cts = null;
                _listaExecutantesServico = null;
                _listaStatus = null;
                _comandoSalvar = null;
        ...
        public ExecutanteServico ExecutanteServicoSelecionado
        {
            get { return _executanteServicoSelecionado; }
            set
            {
                _executanteServicoSelecionado = value;
                OnPropertyChanged(nameof(ExecutanteServicoSelecionado));
                if (ExecutanteServicoSelecionado == null)
                {
                    ExecutanteServicoAlterar = null;
                }
                else
                {
                    ExecutanteServicoAlterar = (ExecutanteServico)ExecutanteServicoSelecionado.Clone();
                    PermiteEditar = ExecutanteServicoAlterar != null;
                    PermiteDeletar = ExecutanteServicoAlterar != null;
                    // Define valores
                    try
                    {
                        ExecutanteServicoAlterar.Status = ListaStatus.First(stat => stat.Id == ExecutanteServicoSelecionado.Status.Id);
                    }
                    catch (Exception)
                    {
                    }
        ...
        public ExecutanteServico ExecutanteServicoAlterar
        {
            get { return _executanteServicoAlterar; }
            set
            {
                _executanteServicoAlterar = value;
                OnPropertyChanged(nameof(ExecutanteServicoAlterar));
            }
        }
        ...
        public ObservableCollection<ExecutanteServico> ListaExecutantesServico
        {
            get { return _listaExecutantesServico; }
            set
            {
                if (value != _listaExecutantesServico)
                {
                    _listaExecutantesServico = value;
                    OnPropertyChanged(nameof(ListaExecutantesServico));
                }
            }
        }
        ...
        public async Task ConstrutorAsync()
        {
            try
            {
                ...
                await ExecutanteServico.PreencheListaExecutantesServicoAsync(ListaExecutantesServico, true, null, CancellationToken.None, "ORDER BY exse.nome ASC", "");
        ...
        {
            ExecutanteServicoAlterar = new ExecutanteServico();
            ExecutanteServicoAlterar.Status = null;
        ...
        private void Cancelar()
        {
            ...
            CancelarVisivel = false;
            PermiteAdicionar = true;
            PermiteEditar = ExecutanteServicoAlterar != null && ExecutanteServicoAlterar?.Id != null; ;
            PermiteCancelar = false;
            PermiteSalvar = false;
            PermiteDeletar = ExecutanteServicoAlterar != null && ExecutanteServicoAlterar?.Id != null; ;
        }
        ...
        private async Task SalvarAsync()
        {
            ...
            MensagemStatus = "Salvando dados do executante do serviço '" + ExecutanteServicoAlterar.Nome + "', aguarde...";
            CancelarVisivel = true;
            PermiteCancelar = true;
            PermiteSalvar = false;
            PermiteAdicionar = false;
            ...
            try
            {
                await ExecutanteServicoAlterar.SalvarExecutanteServicoDatabaseAsync(_cts.Token);
            }
            catch (Exception ex)
            {
                ValorProgresso = 0;
            ...
            int? idExecutanteServicoAlterado = ExecutanteServicoAlterar.Id;
            ...
            try
            {
                ExecutanteServicoSelecionado = ListaExecutantesServico.First(exse => exse.Id == idExecutanteServicoAlterado);
            }
            catch (Exception)
            {
            }
        ...
        private async Task Deletar()
        {
            ...
            var respostaMensagem = await _dialogCoordinator.ShowMessageAsync(this,
                "Atenção", "Tem certeza que deseja excluir o executante do serviço '" + ExecutanteServicoAlterar.Nome + "'? " +
            ...
            ProgressoVisivel = true;
            ProgressoEhIndeterminavel = true;
            MensagemStatus = "Deletando executante do serviço '" + ExecutanteServicoAlterar.Nome + "', aguarde...";
            CancelarVisivel = true;
            PermiteCancelar = true;
            PermiteSalvar = false;
            PermiteAdicionar = false;
            ...
            try
            {
                await ExecutanteServicoAlterar.DeletarExecutanteServicoDatabaseAsync(_cts.Token);
            }
            catch (Exception ex)
            {
                ValorProgresso = 0;
            ...
            ExecutanteServicoSelecionado = null;
            ValorProgresso = 0;
            ListaHabilitada = true;
            ControlesHabilitados = false;
            ProgressoVisivel = false;
            ...
            PermiteEditar = false;
            PermiteDeletar = false;
            MensagemStatus = "Executante do serviço excluído com sucesso!";
